    ...
    <div id="wrapper">
        ...
        <header>
            ...
            <div class="img-wrap">
                ...
                <img src="./img/fv/binavi_topBn_pc-a.jpg" />

                <?php } elseif ($_GET['pat'] == "b") { ?>

                <img src="./img/fv/binavi_topBn_pc-b.jpg" />
                ...
                <img src="./img/fv/binavi_topBn_pc-d.jpg" />

                <?php } elseif ($_GET['pat'] == "e") { ?>

                <img src="./img/fv/binavi_topBn_pc-e.jpg" />

                <?php } elseif ($_GET['pat'] == "f") { ?>

                <img src="./img/fv/binavi_topBn_pc-f.jpg" />

                <?php } elseif ($_GET['pat'] == "g") { ?>

                <img src="./img/fv/binavi_topBn_pc-g.jpg" />

                <?php } elseif ($_GET['pat'] == "h") { ?>

                <img src="./img/fv/binavi_topBn_pc-h.jpg" />
                ...
                <img src="./img/fv/binavi_topBn_pc-a-test2.jpg" />
                ...
                <img src="./img/fv/binavi_topBn_pc-c-test2.jpg" />
                ...
                <img src="./img/fv/binavi_topBn_pc-d-test2.jpg" />
