  ...
  <tbody>
    ...
    <tr>
      <th class="r-title" colspan="2">
        ...
        <p>
          <a target="_blank" href="https://bi-navi.com/links/slilin.php<?php echo "?" . $_SERVER['QUERY_STRING']; ?>" target="_blank">
...
<p>
  ...
  <a target="_blank" href="https://bi-navi.com/links/vita.php<?php echo "?" . $_SERVER['QUERY_STRING']; ?>" target="_blank">
