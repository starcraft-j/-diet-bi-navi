...
<section id="special">
    ...
    <div class="last-item item1">
        <p>テイシ防風通聖散</span> … <span class="bold red">おなかに皮下脂肪が多く、便秘がちな方</span>の<span class="bold red bg-y">肥満症に効く漢方薬！</span></p>
        <p class="right">
        <a target="_blank" href="https://bi-navi.com/links/teishi.php<?php echo "?" . $query2; ?>">→ テイシ防風通聖散を<br />
            お得に買える公式サイト
            </a>
        </p>
    </div>
    <div class="last-item item1">
        ...
        <p class="right">
        <a target="_blank" href="https://bi-navi.com/links/bouhu.php<?php echo "?" . $query2; ?>">→ 生漢煎（しょうかんせん）を<br />
            お得に買える公式サイト
            </a>
        </p>
    </div>
    <div class="last-item item1">
        ...
        <p class="right">
        <a target="_blank" href="https://bi-navi.com/links/eg.php<?php echo "?" . $query2; ?>">→ EGタイトLightを<br />
            お得に買える公式サイト
            </a>
        </p>
    </div>
