...
<section id="section-01">
    ...
    <div class="title-wrap center">
        ...
        <h1 class="center">本当におすすめ！<br>ダイエットスムージー3選！</span></h1>
    </div>
    <!--.title-wrap end-->
...
<section id="section-05">
    ...
    <div class="last-container">
        <div class="last-txt bg-wh border-r">
            ...
            <p>ダイエットスムージ人気No.1の<a target="_blank" href="links/gold.php<?php echo "?" . $query2; ?>"
                    target="_blank">シボヘールGOLDスムージー</a>は 今なら <span class="bold red">初回１９８０円</span>モニター募集中！なんと、 <span
                    class="bold">１日わずか１４０円 </span>で試すことが出来ちゃいます。</p><br>
