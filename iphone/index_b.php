  ...
  <table class="table-01" cellspacing="1">
    ...
    <tbody>
      ...
      <tr>
        ...
        <th>
          <p>
            <a class="link-img" target="_blank" href="./links/llulu.php<?php echo "?" . $query2; ?>">
              <img src="./img/llulu.png" alt="" />
            </a>
          </p>
          <p>
            <span class="lbg">
              <a target="_blank" href="./links/llulu.php<?php echo "?" . $query2; ?>">ラクルル</a>
            </span>
          </p>
        </th>
        ...
        <th>
          <p>
            <a class="link-img" target="_blank" href="./links/cubire.php<?php echo "?" . $query2; ?>">
              <img src="./img/cubire.jpg" alt="">
            </a>
          </p>
          <p>
            <span class="lbg">
              <a target="_blank" href="./links/cubire.php<?php echo "?" . $query2; ?>">クビレ</a>
            </span>
          </p>
        </th>
        ...
        <th>
          <p>
            <a class="link-img" target="_blank" href="./links/eraberu.php<?php echo "?" . $query2; ?>">
          ...
          <p>
            <span class="lbg">
              <a target="_blank" href="./links/eraberu.php<?php echo "?" . $query2; ?>">花菜の選べる乳酸菌</a>
            </span>
          </p>
      ...
      <tr class="btn" style="height: 50px;">
        ...
        <td style="width:28%">
          <a target="_blank" href="./links/llulu.php<?php echo "?" . $query2; ?>">
            <img src="./img/n_img/btn_site_go_s.png" width="100%">
          </a>
        </td>

        <td>
          <a target="_blank" href="./links/cubire.php<?php echo "?" . $query2; ?>">
            <img src="./img/n_img/btn_site_go_s.png" width="100%">
          </a>
        </td>

        <td>
          <a target="_blank" href="./links/eraberu.php<?php echo "?" . $query2; ?>">
            <img src="./img/n_img/btn_site_go_s.png" width="100%">
          </a>
        </td>
