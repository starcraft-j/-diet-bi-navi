    ...
    <div id="wrapper">
        ...
        <header>
            ...
            <div class="img-wrap">
                ...
                <img src="./img/fv/binavi_topBn_sp-a.jpg" />

                <?php } elseif($_GET['pat'] == "b") { ?>

                <img src="./img/fv/binavi_topBn_sp-b.jpg" />
                ...
                <img src="./img/fv/binavi_topBn_sp-d.jpg" />

                <?php } elseif($_GET['pat'] == "e") { ?>

                <img src="./img/fv/binavi_topBn_sp-e.jpg" />

                <?php } elseif($_GET['pat'] == "f") { ?>

                <img src="./img/fv/binavi_topBn_sp-f.jpg" />

                <?php } elseif($_GET['pat'] == "g") { ?>

                <img src="./img/fv/binavi_topBn_sp-g.jpg" />

                <?php } elseif($_GET['pat'] == "h") { ?>

                <img src="./img/fv/binavi_topBn_sp-h.jpg" />

                <?php } elseif($_GET['pat'] == "i") { ?>
                ...
                <img src="./img/fv/binavi_topBn_sp-a-test2.jpg" />

                <?php } elseif ($_SERVER['REQUEST_URI']=="/index_c-test.php") { ?>

                <img src="./img/fv/binavi_topBn_sp-c-test.jpg" />

                <?php } elseif ($_SERVER['REQUEST_URI']=="/index_c-test2.php") { ?>

                <img src="./img/fv/binavi_topBn_sp-c-test2.jpg" />

                <?php } elseif ($_SERVER['REQUEST_URI']=="/index_d-test.php") { ?>

                <img src="./img/fv/binavi_topBn_sp-d.jpg" />

                <?php } elseif ($_SERVER['REQUEST_URI']=="/index_d-test2.php") { ?>

                <img src="./img/fv/binavi_topBn_sp-d-test2.jpg" />
