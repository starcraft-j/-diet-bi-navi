  ...
  <table class="table-01" cellspacing="1">
    ...
    <tbody>
      ...
      <tr>
        ...
        <th class="crown table-title" width="15%">
        </th>
      ...
      <tr>
        ...
        <th>
          <p>
            <a class="link-img" target="_blank" href="./links/maarui.php<?php echo "?" . $query2; ?>">
          ...
          <p>
            <span class="lbg">
            <a target="_blank" href="./links/maarui.php<?php echo "?" . $query2; ?>">まあるい旬<br>生酵素</a>
            </span>
          </p>
        </th>
        ...
        <th>
          <p>
            <a class="link-img" target="_blank" href="./links/berunama.php<?php echo "?" . $query2; ?>">
              <img src="./img/belta.jpg" alt="" />
            </a>
          </p>
          <p>
            <span class="lbg">
              <a target="_blank" href="./links/berunama.php<?php echo "?" . $query2; ?>">ベルタこうじ<br>生酵素</a>
            </span>
          </p>
        </th>
        ...
        <th>
          <p>
            <a class="link-img" target="_blank" href="./links/yoku.php<?php echo "?" . $query2; ?>">
              <img src="./img/yoku.jpg" alt="">
            </a>
          </p>
          <p>
            <span class="lbg">
              <a target="_blank" href="./links/yoku.php<?php echo "?" . $query2; ?>">旬の実酵素</a>
            </span>
          </p>
        </th>
      ...
      <tr>
        ...
        <td>
          <p style="text-align: left">・乳酸菌やビフィズス菌など整腸成分も摂りたい<br>・コラーゲン・ヒアルロン酸・プラセンタなどの美容成分も欲しい</p>
        </td>
      ...
      <tr class="btn" style="height: 50px;">
        ...
        <td>
          <a target="_blank" href="./links/maarui.php<?php echo "?" . $query2; ?>">
            <img src="./img/n_img/btn_site_go_s.png" width="100%">
          </a>                      
        </td>

        <td>
          <a target="_blank" href="./links/berunama.php<?php echo "?" . $query2; ?>">
            <img src="./img/n_img/btn_site_go_s.png" width="100%">
          </a>
        </td>

        <td>
          <a target="_blank" href="./links/yoku.php<?php echo "?" . $query2; ?>">
            <img src="./img/n_img/btn_site_go_s.png" width="100%">
          </a>
        </td>
