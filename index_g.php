...
<section id="section-04">
    ...
    <ul class="tabs">
        ...
        <li class="active" rel="tab7" onclick="rank_bn.src='./img/ranking/ranking-banner-pc-g.png'">ダイエット<br>スムージー</li>
...
<section id="section-05">
    ...
    <div class="last-container">
        ...
        <div class="last-txt bg-wh border-r">
            ...
            <p>ダイエットスムージ人気No.1の<a target="_blank" href="links/gold.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>"
